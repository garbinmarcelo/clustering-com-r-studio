...
# É aplicado o algoritmo de clusterização hierárquica na matriz de distâncias d utilizando o método "average".
# Pode-se utilizar outros métodos como "complete" e "single".
